...
{
    const {purpose, diagnosis, description, treatment, bp, weight, height, bloodsugar, attendingDoc,patientID,gender,age,address,remarks} = req.body
    ...
    try{
        const consultinfo = await consultInfo.create({purpose, diagnosis, description, treatment, bp, weight, height, bloodsugar, attendingDoc,patientID,gender,age,address,remarks})
