   ...
   const [totalPages, setTotalPages] = useState(0);
    ...
    useEffect(() => {
            ...
            const fetchPatient = async () => {
                const response = await fetch(`/portal/health/get?page=${currentPage}&address=${filterAddress?filterAddress.toString():''}&gender=${filterGender.toString()}&services=${filterServices.toString()}`);
              ...
              fetchPatient();
	}, [filterAddress,filterGender,filterServices]);

  const exportToExcel = async() => {
  
     try{
      await axios.get(`/portal/health/get?address=${filterAddress?filterAddress.toString():''}&gender=${filterGender.toString()}&services=${filterServices.toString()}`)
      .then(response => {
...
{/*           
         ...
         {/* <div class='flex flex-row items-center justify-center mb-10'>
          ...
          <div class='p-6'>
          <Button class='float-right bg-gray-200 p-2 rounded' onClick={exportToExcel}>Export to Excel (.xlsx) file</Button>
        ...
        <ModalContent>
          ...
          <div class="mt-7 overflow-x-auto">
              ...
              <tr tabindex="0" class="focus:outline-none h-14 border border-gray-100 rounded">
                  ...
                  {item.filtered &&item.filtered.map(item => 
